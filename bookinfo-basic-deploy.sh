oc create -n bookinfo -f  deployment/bookinfo-deployment.yaml
oc create -n bookinfo -f  deployment/bookinfo-gateway.yaml
oc create -n bookinfo -f  deployment/bookinfo-destinationrules-all-mtls.yaml
